...
<div class="card-subtitle">Deslumbrar a la élite de Silicon Valley • FAQ</div>
...
<div class="card-subtitle">Monitorización de noticias y eventos en el País Vasco • News & Network</div>
<div class="card-btn">Explorar App</div>
</div>
</div>
</a>
