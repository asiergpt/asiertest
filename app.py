...
# ─────────────────────────────────────────────
# WEB COMPLETA EN UN SOLO BLOQUE (Cero espacios fantasma)
# ─────────────────────────────────────────────
html_completo = f"""
<!DOCTYPE html>
<html>
...
<style>
    ...
    * {{ box-sizing: border-box; margin: 0; padding: 0;
    ...
    .products-section-container {{
        /* AQUI CONTROLAMOS EL ESPACIO EXACTO ENTRE BLOQUES */
        margin-top: 30px; 
...
<script>
    ...
    // Sincronización de altura maestra para Streamlit
...
# Le damos un height grande de base, total Streamlit lo ajustará perfecto
st.components.v1.html(html_completo, height=1800, scrolling=False)